# PROGRESS — the Phase 0 build log, to 12 August 2026

Archived from `docs/PROGRESS.md` to keep a cold start cheap. **Nothing here is superseded** — it
is the record of how Phase 0 was built and, more usefully, of the bugs that were found the hard
way. The lessons that still bind are summarised at the top of the live `PROGRESS.md`; this is the
detail behind them.

Read it when you need provenance for a decision, not on the way in.
